          ...
          <div className="w-[30%] flex flex-col pr-10 sticky top-[25vh]">
            ...
            >
              <div className="pointer-events-none">
                <h2 
                  className={`uppercase ${language === 'en' ? 'text-[clamp(40px,7vw,90px)] font-black font-sans tracking-tighter leading-[1.05]' : 'text-[clamp(36px,6vw,84px)] font-black font-puhuiti tracking-tighter leading-[1.1] [-webkit-text-stroke:2px_currentColor]'} mb-6`}
                >
                ...
                <div className="flex items-center gap-4 mb-20">
                  ...
                  <h4 className={`text-white/70 text-[16px] md:text-[20px] italic font-normal ${language === 'en' ? 'tracking-normal' : 'tracking-wide'}`}>
                ...
                <div className="transition-opacity duration-500 ease-[cubic-bezier(0.25,1,0.5,1)]" style={{ opacity: activeIdx !== null ? 0.15 : 1 }}>
                  <h3 className="text-xl md:text-[22px] font-extrabold mb-6 text-white tracking-tight">
                    {language === 'en' ? 'GLOBAL Validation | Crydit (0-1)' : '包揽国际设计奖项 | Crydit（0-1阶段）'}
                  </h3>
                  <p className="text-white/70 text-[16px] md:text-[20px] leading-[1.8] max-w-[90%] font-normal tracking-wide">
                    {language === 'en' 
              ...
              return (
                ...
                >
                  <div className="flex items-center w-full min-h-[48px]">
                    ...
                    <span className="text-white/30 font-space-grotesk text-[16px] md:text-[18px] font-bold tracking-widest w-16 shrink-0 transition-colors duration-500">
                      {item.id}
                    </span>
