      ...
      <div className="w-full flex flex-col -translate-y-[30px]">
        ...
        <div className="space-y-12 max-w-[1000px]">
           <div className="flex flex-col">
             <h2 className="text-[86px] font-black font-sans tracking-tight leading-[1.1] uppercase mb-6">
               NICKI
             </h2>
             <div className="flex items-center gap-4">
                <div className="w-16 h-[1px] bg-white/30" />
                <h4 className={`text-white/70 text-[14px] md:text-[18px] italic font-normal ${isEn ? 'tracking-normal' : 'tracking-wide'}`}>
                  {isEn ? "A pragmatic visual problem solver who acts beyond theory." : "一个绝不纸上谈兵的视觉问题解决者。"}
                </h4>
             </div>
           </div>

           <div className={`text-[14px] md:text-[18px] text-white/70 font-normal pt-2 ${isEn ? 'tracking-normal space-y-6 leading-[1.6]' : 'tracking-wide space-y-3 leading-[1.6]'}`}>
        ...
        <div className="space-y-10 mt-[130px] md:mt-[150px]">
          <h3 
            className={
              isEn 
                ? "text-4xl md:text-[54px] font-black tracking-tighter leading-none font-sans uppercase"
                : "text-4xl md:text-5xl font-extrabold tracking-tighter font-['PingFang_SC','Microsoft_YaHei']"
            }
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 xl:gap-x-32 gap-y-12 w-full">
              ...
              <div className="flex flex-col space-y-3">
                <h4 className="text-[16px] md:text-[20px] font-bold leading-snug">01 | {isEn ? 'Cross-Domain Visual Strategy' : '跨域视觉战略'}</h4>
                <p className="text-[14px] md:text-[13px] text-white/50 font-normal tracking-wide leading-relaxed">
                  {isEn 
              ...
              {/* Item 2 */}
              <div className="flex flex-col space-y-3">
                <h4 className="text-[16px] md:text-[20px] font-bold leading-snug">02 | {isEn ? 'Business Conversion Oriented' : '商业转化导向'}</h4>
                <p className="text-[14px] md:text-[13px] text-white/50 font-normal tracking-wide leading-relaxed">
                  {isEn 
              ...
              <div className="flex flex-col space-y-3 mt-[20px]">
                <h4 className="text-[16px] md:text-[20px] font-bold leading-snug">03 | {isEn ? 'Exclusive AI Workflow' : '独家智能工作流'}</h4>
                <p className="text-[14px] md:text-[13px] text-white/50 font-normal tracking-wide leading-relaxed">
                  {isEn 
              ...
              {/* Item 4 */}
              <div className="flex flex-col space-y-3 mt-[20px]">
                <h4 className="text-[16px] md:text-[20px] font-bold leading-snug">04 | {isEn ? 'Agile Collaborative Leadership' : '敏捷协同领导力'}</h4>
                <p className="text-[14px] md:text-[13px] text-white/50 font-normal tracking-wide leading-relaxed">
                  {isEn 
