      ...
      <div className="w-full relative mt-10">
        ...
        <div className="max-w-[1400px] w-full mx-auto relative flex items-center justify-between px-6 md:px-[60px] lg:px-[80px]">
          ...
          <div className="flex gap-10 md:gap-20 z-10 bg-[#050505] px-4 -ml-4">
            <span className="font-space-grotesk text-[16px] md:text-[18px] font-bold text-white tracking-widest uppercase">01</span>
            <span className="font-space-grotesk text-[16px] md:text-[18px] font-bold text-white tracking-widest uppercase">02</span>
          </div>
          ...
          <div className="flex gap-10 md:gap-20 z-10 bg-[#050505] px-4 -mr-4">
            <span className="font-space-grotesk text-[16px] md:text-[18px] font-bold text-white tracking-widest uppercase">03</span>
            <span className="font-space-grotesk text-[16px] md:text-[18px] font-bold text-white tracking-widest uppercase">04</span>
          </div>
