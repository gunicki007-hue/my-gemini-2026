    ...
    <section className="relative w-full py-24 md:py-32 px-6 lg:px-[80px] bg-[#0a0a0a] overflow-visible">
      <div className="w-full flex flex-col lg:flex-row justify-between items-center mx-auto gap-12 lg:gap-0">
        ...
        <div className="w-full lg:w-[35%] flex flex-col z-10 lg:pr-8 xl:pr-12">
          ...
          >
            <div className="text-[#D5B667] text-[16px] md:text-[16px] font-sans font-bold tracking-[0.3em] uppercase mb-4">
            ...
            <div className={`flex flex-col gap-8 w-full max-w-[500px] ${isEn ? 'text-white/70 font-sans font-light tracking-[0.015em] leading-[1.5] text-[16px] md:text-[16px]' : 'text-white/70 font-sans font-light tracking-[0.03em] leading-[1.6] text-[16px] xl:text-[16px] text-justify'}`}>
              <p>
                {isEn 
