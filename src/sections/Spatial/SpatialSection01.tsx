        ...
        <div className="w-full lg:w-[35%] lg:sticky lg:top-[12vh] flex flex-col z-10 lg:pr-8 xl:pr-12">
          ...
          >
            <div className="flex items-center gap-4 mb-8 md:mb-12">
              ...
              <h4 className="text-[#A66B4E] tracking-tighter text-[14px] md:text-[16px] uppercase font-sans font-bold whitespace-nowrap">
                {isEn ? 'CASE 01 · PHYSICAL LANDING · SPATIAL PROJECT' : 'CASE 01 · 物理着陆 · 空间全案'}
              </h4>
            </div>
            
            <h3 className="text-white text-[40px] md:text-[50px] xl:text-[56px] font-black leading-[1.1] mb-8 md:mb-10 tracking-tighter font-sans uppercase">
              {isEn ? (
            ...
            <div className="space-y-6">
              ...
              <div className={`pt-4 ${isEn ? 'text-white/50 text-[16px] md:text-[18px] leading-[1.8]' : 'text-white/50 text-[16px] md:text-[18px] leading-[32px] md:leading-[36px] tracking-widest text-justify'}`}>
                {isEn ? (
          ...
          >
            ...
            <div className="w-full aspect-[16/9] rounded-[16px] md:rounded-[24px] overflow-hidden relative bg-[#111] flex items-center justify-center group shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
              ...
              <div className="absolute inset-x-0 bottom-0 p-5 md:p-8 bg-gradient-to-t from-black via-black/60 to-transparent z-10">
                <p className="text-white/50 text-[15px] md:text-[15px] font-sans tracking-wider">
            ...
            <div className="flex flex-row gap-3 md:gap-4 w-full h-[180px] sm:h-[220px] lg:h-[260px] xl:h-[300px]">
               {/* Bottom Left Image */}
               <div className="flex-[1.8] xl:flex-[2.2] h-full rounded-[16px] md:rounded-[24px] overflow-hidden relative bg-[#111] flex items-center justify-center group shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
                 <img 
               ...
               {/* Bottom Right Image */}
               <div className="flex-1 h-full rounded-[16px] md:rounded-[24px] overflow-hidden relative bg-[#111] flex items-center justify-center group shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
                 <img 
