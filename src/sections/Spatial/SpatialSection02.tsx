      ...
      <div className="w-full flex flex-col lg:flex-row justify-between items-start mx-auto gap-12 lg:gap-0">
        ...
        <div className="w-full lg:w-[35%] lg:sticky lg:top-[12vh] flex flex-col z-10 lg:pr-8 xl:pr-12">
          ...
          >
            ...
            <div className={`space-y-8 ${isEn ? 'text-white/60 font-sans font-light tracking-wide' : 'text-white/60 text-justify tracking-widest'}`}>
              ...
              <p className={`leading-[30px] md:leading-[36px] ${isEn ? 'text-[16px] md:text-[18px]' : 'text-[16px] md:text-[18px]'}`}>
                {isEn ? (
