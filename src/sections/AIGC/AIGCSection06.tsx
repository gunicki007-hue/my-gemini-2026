  ...
  return (
    <section className="relative w-full h-screen py-24 md:py-32 px-6 md:px-[80px] bg-[#050505] overflow-hidden flex flex-col justify-center border-t border-white/[0.02]">
      ...
      >
        ...
        <h2 className={`uppercase w-full ${isEn ? 'text-[clamp(24px,5vw,64px)] font-extrabold font-sans tracking-tighter leading-[1.05]' : 'text-[clamp(24px,5vw,70px)] font-bold font-puhuiti tracking-tighter leading-[1.1] [-webkit-text-stroke:2px_currentColor]'} mb-24 md:mb-40`}>
          {isEn ? (
        ...
        <h3 className={`w-full max-w-[1200px] mb-16 md:mb-24 ${isEn ? 'text-[24px] font-light tracking-wide leading-[48px] font-sans text-white/90' : 'text-[24px] font-extrabold tracking-tighter font-puhuiti leading-[48px]'}`}>
          {isEn ? (
        ...
        <p className={`w-full max-w-[900px] text-left ${isEn ? 'text-white/70 font-sans font-light tracking-[0.015em] leading-[1.5] text-[14px] xl:text-[14px]' : 'text-white/70 font-sans font-light tracking-[0.03em] leading-[1.6] text-[14px] xl:text-[14px] text-justify'}`}>
          {isEn ? (
