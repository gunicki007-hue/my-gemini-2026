...
export const AIGCOutro = () => {
  ...
  return (
    <section className="relative w-full min-h-[50vh] flex flex-col items-center justify-center p-6 bg-[#0a0a0a] overflow-hidden">
      ...
      >
        <h2 className={`leading-tight bg-clip-text text-transparent bg-gradient-to-b from-white to-[#a3a3a3] mb-12 max-w-[800px] text-balance ${isEn ? 'uppercase tracking-tighter text-[16px] md:text-[26px] font-sans font-extrabold' : 'tracking-tighter text-[20px] md:text-[26px] font-puhuiti font-extrabold'}`}>
        ...
        <button 
          onClick={() => {
            navigate('/', { state: { scrollTo: 'projects', projectId: 'aigc' } });
          }}
        ...
        >
          ...
          <span className="text-[14px] md:text-[14px] font-bold tracking-tighter uppercase mt-[1px]">
            {isEn ? 'BACK' : '返回项目列表'}
          </span>
        </button>
      </motion.div>
