...
export const Web3Outro = () => {
  ...
  return (
    <section className="relative w-full min-h-[50vh] flex flex-col items-center justify-center p-6 bg-[#0a0a0a] overflow-hidden">
      ...
      >
        <h2 className={`leading-tight bg-clip-text text-transparent bg-gradient-to-b from-white to-[#a3a3a3] mb-12 ${isEn ? 'uppercase tracking-[0.2em] text-[24px] md:text-[32px] font-sans font-bold' : 'tracking-[0.1em] text-[24px] md:text-[30px] font-["PingFang_SC","Microsoft_YaHei"] font-medium'}`}>
        ...
        <button 
          onClick={() => {
            ...
            if (lenis) {
              // we probably should navigate home
            }
            navigate('/', { state: { scrollTo: 'projects', projectId: 'web3' } });
          }}
