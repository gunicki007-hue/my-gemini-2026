          ...
          >
            ...
            <div className="w-full flex-1 flex flex-col relative z-10 justify-between">
              ...
              <div className="w-full pb-6 md:pb-8 flex items-center border-b border-white/[0.05]">
                <div className="flex-[0.6] text-white/70 text-[12px] md:text-[13px] tracking-tighter">{isEn ? 'DIMENSION' : '维度'}</div>
                <div className="flex-1 text-white/70 text-[12px] md:text-[13px] tracking-tighter pl-4">{isEn ? 'TRADITIONAL MODE' : '传统方式'}</div>
                <div className="flex-1 text-white/70 text-[12px] md:text-[13px] tracking-tighter pl-4">{isEn ? 'HYBRID ORCHESTRATION' : '混合智能体编排'}</div>
              </div>
