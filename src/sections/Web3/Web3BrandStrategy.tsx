  ...
  return (
    <section className="relative w-full min-h-[90vh] flex flex-col xl:flex-row items-center justify-between pl-6 pr-0 md:pl-[60px] lg:pl-[80px] py-16 xl:py-24 gap-12 lg:gap-16 overflow-hidden bg-[#0a0a0a]">
         ...
         >
           {isEn ? (
             <>
               ...
               <span className="text-transparent" style={{ WebkitTextStroke: '1px rgba(255,255,255,0.4)' }}>& Narrative </span><br />
      ...
      >
         ...
         <div className="w-full h-full relative aspect-[1.8/1] sm:aspect-[2/1] xl:aspect-auto xl:h-[800px] bg-transparent overflow-hidden rounded-l-[12px] sm:rounded-l-[24px]">
