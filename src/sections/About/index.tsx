        ...
        <div className="space-y-12 max-w-[1000px]">
           <div className="flex flex-col">
             ...
             <div className="flex items-center gap-4">
                ...
                <h4 className={`text-white/70 text-[12px] md:text-[16px] italic font-normal ${isEn ? 'tracking-normal' : 'tracking-wide'}`}>
                  {isEn ? "A pragmatic visual problem solver who acts beyond theory." : "一个绝不纸上谈兵的视觉问题解决者。"}
                </h4>
             </div>
           </div>

           <div className={`text-[12px] md:text-[16px] text-white/70 font-normal pt-2 ${isEn ? 'tracking-normal space-y-6 leading-[1.6]' : 'tracking-wide space-y-3 leading-[1.6]'}`}>
