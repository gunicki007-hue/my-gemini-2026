  ...
  return (
    <section className="relative w-full py-24 md:py-32 px-6 lg:px-[80px] bg-[#0a0a0a] overflow-visible">
      <div className="w-full grid grid-cols-1 lg:grid-cols-10 items-start gap-12 lg:gap-20">
        ...
        <div className="col-span-1 lg:col-span-4 flex flex-col lg:sticky lg:top-[12vh] z-10">
          ...
          >
            <div className="flex items-center gap-4 mb-8 md:mb-12">
              ...
              <h4 className="text-[#D5B667] tracking-tighter text-[14px] md:text-[14px] uppercase font-sans font-bold">
                {isEn ? 'CASE 03 · AGILITY & HIGH CONCURRENCY · TEA' : 'CASE 03 · 敏捷与高并发 · 茶颜悦色'}
              </h4>
            </div>
            <h3 className="text-white text-[28px] md:text-[36px] xl:text-[44px] font-extrabold leading-[1.1] mb-6 tracking-tighter font-sans uppercase">
              {isEn ? (
            ...
            <div className={`space-y-6 ${isEn ? 'text-white/70 font-sans font-light tracking-[0.015em] leading-[1.5] text-[14px] md:text-[14px]' : 'text-white/70 font-sans font-light tracking-[0.03em] leading-[1.6] text-[14px] xl:text-[14px] text-justify'}`}>
        ...
        {/* Right Column (Images) */}
        <div className="col-span-1 lg:col-span-6 flex flex-col gap-16 md:gap-32 relative z-0 mt-[30px]">
          ...
          >
            <div className="flex flex-col gap-2 mb-2">
              <span className="text-[#D5B667] tracking-tighter text-[14px] font-sans font-bold uppercase flex items-center gap-2">
                <span className="font-mono slashed-zero text-[14px]">01</span>
                {isEn ? 'BRAND VISUAL FOUNDATION' : '品牌视觉基座'}
              </span>
              <p className="text-white text-[14px] md:text-[13px] font-normal tracking-wide">
            ...
            <div className="w-full aspect-video rounded-[24px] overflow-hidden relative flex items-center justify-center">
              ...
              <div className="absolute bottom-6 left-8 z-10">
                <span className="text-white/70 text-[14px] md:text-[14px] font-medium tracking-tighter">
            ...
            <div className="flex flex-col gap-2 mt-2">
              <h5 className="text-white text-[14px] md:text-[14px] font-medium tracking-wide">
                {isEn ? 'Training Set Tagging Example' : '训练集打标示例'}
              </h5>
              <p className="text-white/70 text-[7px] md:text-[8px] font-light leading-relaxed text-justify break-words w-full">
                {isEn 
          ...
          >
            <div className="flex flex-col gap-2 mb-2">
              <span className="text-[#D5B667] tracking-tighter text-[14px] font-sans font-bold uppercase flex items-center gap-2">
                <span className="font-mono slashed-zero text-[14px]">03</span>
          ...
          >
            <div className="flex flex-col gap-2 mb-2">
              <span className="text-[#D5B667] tracking-tighter text-[14px] font-sans font-bold uppercase flex items-center gap-2">
                <span className="font-mono slashed-zero text-[14px]">04</span>
