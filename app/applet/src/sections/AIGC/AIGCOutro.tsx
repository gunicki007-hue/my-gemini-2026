...
export const AIGCOutro = () => {
  ...
  return (
    <section className="relative w-full min-h-[50vh] flex flex-col items-center justify-center p-6 bg-[#0a0a0a] overflow-hidden">
      ...
      >
        <h2 className={`leading-tight bg-clip-text text-transparent bg-gradient-to-b from-white to-[#a3a3a3] mb-12 max-w-[800px] text-balance ${isEn ? 'uppercase tracking-[0.2em] text-[20px] md:text-[28px] font-sans font-bold' : 'tracking-[0.1em] text-[24px] md:text-[32px] font-["PingFang_SC","Microsoft_YaHei"] font-medium'}`}>
