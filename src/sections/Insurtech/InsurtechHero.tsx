    ...
    <section className="relative w-full h-[60vh] md:h-[70vh] flex items-end pb-12 md:pb-24 px-6 md:px-[60px] lg:px-[80px] bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="relative z-10 w-full flex flex-col md:flex-row items-start md:items-end justify-between gap-8 md:gap-12 mt-32">
        ...
        >
          ...
          {/* Main Title */}
          <h1 
            className={`uppercase leading-none tracking-tighter ${isEn ? 'text-[clamp(24px,4.5vw,60px)] font-extrabold font-sans break-words' : 'text-[clamp(26px,5vw,72px)] font-extrabold font-puhuiti break-words'}`}
          >
            {isEn ? (
        ...
        >
           <p className={`text-white/70 text-pretty ${isEn ? 'text-[16px] xl:text-[16px] tracking-normal leading-[1.6]' : 'text-[16px] xl:text-[16px] tracking-tighter leading-[1.6]'}`}>
             {isEn 
