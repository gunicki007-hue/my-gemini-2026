...
export const Web3Outro = () => {
  ...
  return (
    <section className="relative w-full min-h-[50vh] flex flex-col items-center justify-center p-6 bg-[#0a0a0a] overflow-hidden">
      ...
      >
        <h2 className={`leading-tight bg-clip-text text-transparent bg-gradient-to-b from-white to-[#a3a3a3] mb-12 ${isEn ? 'uppercase tracking-tighter text-[24px] md:text-[32px] font-sans font-black' : 'tracking-tighter text-[24px] md:text-[30px] font-puhuiti font-black'}`}>
